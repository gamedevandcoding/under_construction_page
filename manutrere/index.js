...
/* --------------------------------- POPUP MESSAGE --------------------------------- */
const popup_message = document.getElementById("popup_container");
const disabled_btns = document.getElementsByClassName("disabled_btn");
for (let i = 0; i < disabled_btns.length; i++){
    disabled_btns[i].addEventListener('click', function(){
        popup_message.style.display = "flex";
